...
export type MobileRoomTransport = {
  ...
  readyNextRound: (expectedActionId: string) => Promise<ClientTransportActionResult>;
  startNextRound: (expectedActionId: string) => Promise<ClientTransportActionResult>;
  finishGame: (expectedActionId: string) => Promise<ClientTransportActionResult>;
